...
public class CompareStoredQueriesFixture extends Fixture {
	...
	private DataTable getDataTable(String symbolName) {
		...
		throw new UnsupportedOperationException("Cannot load stored query from " + symbolName + " - object type is "
				+ o.getClass().getName());
	}
