...
public class DbTypeAdapter extends TypeAdapter {
	...
	private Object parseSymbol(String s) throws Exception {
		Object value = org.jtester.dbfit.util.SymbolUtil.getSymbol(s.substring(2).trim());
		...
		try {
			...
			throw new UnsupportedOperationException("Incompatible types between symbol and cell value: expected "
	...
	public Object parse(String s) throws Exception {
		...
		if (trim.toLowerCase().equals("null"))
			return null;
		if (this.type.equals(String.class) && Options.isFixedLengthStringParsing() && trim.startsWith("'")
				&& trim.endsWith("'")) {
