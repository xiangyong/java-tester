...
public class CalendarAssertTest extends JTester {
	...
	public void yearIs() {
		...
		checking(new Je() {
			{
				$.one(idate).setDate(the.date().yearIs(2009).yearIs("2009").wanted());
				$.one(idate).setCalendar(the.calendar().yearIs(2009).yearIs("2009").wanted());
			}
		});
	...
	public void yearIs_failure2() {
		checking(new Je() {
			{
				$.one(idate).setDate(the.date().yearIs(2009).yearIs("2008").wanted());
				$.one(idate).setCalendar(the.calendar().yearIs(2009).yearIs("2009").wanted());
			}
		});
		testApp.setTime(date, cal);
	...
	public void yearIs_failure3() {
		checking(new Je() {
			{
				$.one(idate).setDate(the.date().yearIs(2009).yearIs("2009").wanted());
				$.one(idate).setCalendar(the.calendar().yearIs(2008).wanted());
			}
		});
		testApp.setTime(date, cal);
	}
	...
	public void monthIs() {
		...
		checking(new Je() {
			{
				$.one(idate).setDate(the.date().monthIs(4).monthIs("04").wanted());
				$.one(idate).setCalendar(the.calendar().monthIs(4).monthIs("4").wanted());
			}
		});
		testApp.setTime(date, cal);
	}
	...
	public void dayIs() {
		...
		checking(new Je() {
			{
				$.one(idate).setDate(the.date().dayIs(12).dayIs("12").wanted());
				$.one(idate).setCalendar(the.calendar().dayIs(12).dayIs("12").wanted());
			}
		});
		testApp.setTime(date, cal);
	}
	...
	public void hourIs() {
		...
		checking(new Je() {
			{
				$.one(idate).setDate(the.date().hourIs(15).hourIs("15").wanted());
				$.one(idate).setCalendar(the.calendar().hourIs(15).hourIs("15").wanted());
			}
		});
		testApp.setTime(date, cal);
	}
	...
	public void minuteIs() {
		...
		checking(new Je() {
			{
				$.one(idate).setDate(the.date().minuteIs(36).minuteIs("36").wanted());
				$.one(idate).setCalendar(the.calendar().minuteIs(36).minuteIs("36").wanted());
			}
		});
		testApp.setTime(date, cal);
	}
	...
	public void secondIs() {
		...
		checking(new Je() {
			{
				$.one(idate).setDate(the.date().secondIs(24).secondIs("24").wanted());
				$.one(idate).setCalendar(the.calendar().secondIs(24).secondIs("24").wanted());
			}
		});
		testApp.setTime(date, cal);
	}
